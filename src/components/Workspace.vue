<template>
    <v-container>
      ...
      <v-card flat class="w-100 d-flex pa-3">
        <v-btn class="flex-fill ma-1" flat @click="create" color="primary">建立工作區</v-btn>
        <v-btn class="flex-fill ma-1" flat @click="importt" color="warning">匯入</v-btn>
        <v-btn class="flex-fill ma-1" flat @click="exportt" color="warning" :disabled="!is_select_workspace">匯出</v-btn>
      </v-card>
      ...
      <v-card flat class="w-100 d-flex pa-3">
        <v-btn class="flex-fill" flat @click="addproject" :disabled="!is_select_workspace" color="primary">加入專案</v-btn>
      </v-card>
      ...
      <v-dialog v-model="create_dialog" width="500">
        <v-card flat class="pa-4">
          ...
          <v-card-actions>
            ...
            <v-btn @click="create_dialog = false" color="error">取消</v-btn>
          </v-card-actions>
        </v-card>
      </v-dialog>
